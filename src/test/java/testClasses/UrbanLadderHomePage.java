...
// TC001 - To navigate to the Webpage "https://www.urbanladder.com/" and assert the page title.
	@Test
...
//	TC007	To validate the visibility of price, storage type,type,material/finish,brand under Filter tab, when BookShelves icon is clicked under "Explore our Furniture Range".
	@Test(priority=6)
...
//	TC008	To validate the visibility of CheckBox, Exclude out of stock, when BookShelves icon is clicked under "Explore our Furniture Range".
	@Test(priority=7)
	public void testVisibilityOfStockCheckBox() {
		Assert.assertTrue(PageBaseClass.isElementVisible(bookshelves.stockCheckBox));;
	}
	
//	TC009	To validate the visibility of list box under Sort By
	@Test(priority=8)
	public void testVisibilityOfSortByOption() {
		Assert.assertTrue(PageBaseClass.isElementVisible(bookshelves.sortByOption));
	}
//	TC010	To display the name, price of Bookshelves below Rs. 15000 with Including out of stock and Storage type should be open.
	@Test(priority=9)
	public void printBookshelvesDetailsIncluding() {
		bookshelves.printBookshelvesIncluding();
	}
	
//	TC011	To display the first 3 name, price of Bookshelves below Rs. 15000 with Excluding out of stock and Storage type should be open.
	@Test(priority=10)
	public void printBookshelvesDetailsExcluding() {
		bookshelves.printBookshelvesExcluding();
	}
	
//	TC012	To validate the visibility of "Being-At-home" category under "collections" main category.
	@Test(priority=1)
